...
namespace MPCdotNet.Client
{
    ...
    {
        private List<Keys> m_CapturedKeys = new List<Keys>();
        /// <summary>
        ...
        public KeyboardListener(params Keys[] capturedKeys) : this()
        {
            m_CapturedKeys.AddRange(capturedKeys);
        }
        ...
        private IntPtr LowLevelKeyboardProc(int nCode, UIntPtr wParam, IntPtr lParam)
        {
            if (nCode >= 0)
                ...
                {
                    if (m_CapturedKeys.Count == 0 || m_CapturedKeys.Contains((Keys)Marshal.ReadInt32(lParam)))
                    {
